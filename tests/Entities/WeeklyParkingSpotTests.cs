...
public class WeeklyParkingSpotTests
{
    ...
    public void given_invalid_date_add_reservation_should_fail(string dateString)
    {
        ...
        //ARRANGE
        var reservation = new VehicleReservation(Guid.NewGuid(), "Joe Doe", "XYZ123", 1, new Date(invalidDate));
    ...
    public void given_reservation_for_already_existing_date_add_reservation_should_fail()
    {
        ...
        var reservation = new VehicleReservation(Guid.NewGuid(), "Joe Doe", "XYZ123", 1, reservationDate);
